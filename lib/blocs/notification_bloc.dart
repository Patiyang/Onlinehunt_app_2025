...
Future<Article> getArticleById(String id) async => await _firestore.collection('contents').doc(id).get().then((doc) {
  return Article.fromFirestore(doc);
});

class CustomPlaceHolder extends StatelessWidget {
  const CustomPlaceHolder({Key? key, this.size}) : super(key: key);
