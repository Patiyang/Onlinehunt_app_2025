...
class _MoreArticlesState extends State<MoreArticles> {
  ...
  Future<Null> _getData() async {
    ...
    if (_lastVisible == null)
      data = await firestore.collection(collectionName).orderBy(_orderBy, descending: _descending).limit(8).get();
    else
      data = await firestore.collection(collectionName).orderBy(_orderBy, descending: _descending).startAfter([_lastVisible![_orderBy]]).limit(8).get();
          ...
          slivers: <Widget>[
            SliverAppBar(
              ...
              flexibleSpace: FlexibleSpaceBar(
                ...
                title: Text(widget.title, style: TextStyle(fontWeight: FontWeight.bold)).tr(),
