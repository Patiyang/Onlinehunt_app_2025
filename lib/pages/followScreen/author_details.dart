...
//       appBar: AppBar(
//         centerTitle: true,
//         title: Text(loadingUserDetails ? "---" : _userDetails!.first_name!, style: TextStyle(fontWeight: FontWeight.bold, fontSize: 17, letterSpacing: .3)),
//         actions: [
//           IconButton(
//             onPressed: () {
//               AppService().openLinkWithCustomTab(context, 'https://onlinehunt.in/news/rss/author/${_userDetails!.first_name}');
//             },
