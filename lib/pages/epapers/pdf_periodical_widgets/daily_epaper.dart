...
class DailyPDFEpaper extends StatefulWidget {
  const DailyPDFEpaper({super.key});

  @override
  State<DailyPDFEpaper> createState() => _DailyPDFEpaperState();
}

class _DailyPDFEpaperState extends State<DailyPDFEpaper> with AutomaticKeepAliveClientMixin {
  ...
  Widget build(BuildContext context) {
    super.build(context);
    final dp = context.watch<DailyPDFPeriodicalBloc>();
            ...
            children: <Widget>[
              ...
              Visibility(
                ...
                child: TextButton(
                  ...
                  onPressed: () => nextScreen(context, MorePDFEpapers(periodType: 'daily',source_type: 'pdf',)),
                ),
              ),
            ],
          ),
