...
class MonthlyPDFPeriodicals extends StatefulWidget {
  const MonthlyPDFPeriodicals({super.key});

  @override
  State<MonthlyPDFPeriodicals> createState() => _MonthlyPDFPeriodicalsState();
}

class _MonthlyPDFPeriodicalsState extends State<MonthlyPDFPeriodicals> {
  @override
  Widget build(BuildContext context) {
    final mp = context.watch<MonthlyPDFPeriodicalBloc>();
    return Column(
      children: [
        Padding(
            ...
            children: <Widget>[
              ...
              Visibility(
                ...
                child: TextButton(
                  ...
                  onPressed: () => nextScreen(context, MorePDFEpapers(periodType: mp.data[0].publication!.publication_type,source_type: 'pdf')),
                ),
              ),
            ],
          ),
