...
class WeeklyPDFPeriodical extends StatefulWidget {
  const WeeklyPDFPeriodical({super.key});

  @override
  State<WeeklyPDFPeriodical> createState() => _WeeklyPDFPeriodicalState();
}

class _WeeklyPDFPeriodicalState extends State<WeeklyPDFPeriodical> {
  @override
  Widget build(BuildContext context) {
    final pb = context.watch<WeeklyPDFPeriodicalBloc>();
    return Column(
      children: [
        Padding(
            ...
            children: <Widget>[
              ...
              Visibility(
                ...
                child: TextButton(
                  ...
                  onPressed: () => nextScreen(context, MorePDFEpapers(periodType: pb.data[0].publication!.publication_type,source_type: 'pdf')),
                ),
              ),
            ],
          ),
