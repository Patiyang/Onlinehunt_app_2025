...
class MorePDFEpapers extends StatefulWidget {
  final String? periodType;
  final String? source_type;
  const MorePDFEpapers({super.key, this.periodType, this.source_type='website'});

  @override
  State<MorePDFEpapers> createState() => _MorePDFEpapersState();
}

class _MorePDFEpapersState extends State<MorePDFEpapers> {
  int currentPage = 1;
