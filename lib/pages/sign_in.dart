...
import 'package:online_hunt_news/pages/forgot_password.dart';
import 'package:online_hunt_news/pages/sign_up.dart';
        ...
        child: Padding(
          ...
          child: ListView(
            children: <Widget>[
              ...
              SizedBox(height: 80),
              TextFormField(
                decoration: InputDecoration(hintText: 'username@mail.com', labelText: 'Email'),
              ...
              Container(
                ...
                child: TextButton(
                  child: Text('forgot password?', style: TextStyle(color: Theme.of(context).primaryColor)).tr(),
                  onPressed: () {
              ...
              Container(
                height: 45,
                child: TextButton(
                  style: ButtonStyle(backgroundColor: WidgetStateProperty.resolveWith((states) => Theme.of(context).primaryColor)),
