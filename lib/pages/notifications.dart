...
import 'package:online_hunt_news/widgets/article_notifications.dart';
import 'package:online_hunt_news/widgets/custom_notifications.dart';
...
class _NotificationsPageState extends State<NotificationsPage> with SingleTickerProviderStateMixin {
  ...
  List<Tab> _tabs = [Tab(text: "custom notifications".tr()), Tab(text: 'news notifications'.tr())];
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: TabBarView(controller: _tabController, children: [CustomNotifications(), ArticleNotifications()]),
    );
  }
}
