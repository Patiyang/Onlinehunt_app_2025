...
import 'package:online_hunt_news/pages/aricleUploads/addArticle.dart';
        ...
        children: <Widget>[
          InkWell(
            child: CircleAvatar(
              ...
              backgroundImage: sb.guestUser ? CachedNetworkImageProvider(sb.defaultUserImageUrl) : CachedNetworkImageProvider(sb.imageUrl!),
            ),
            onTap: () {
