...
import 'package:online_hunt_news/models/notification.dart';
import 'package:online_hunt_news/pages/notification_details.dart';
                  ...
                  children: [
                    ...
                    Row(
                      children: <Widget>[
                        ...
                        SizedBox(width: 5),
                        Text(d.date!, style: TextStyle(color: Theme.of(context).secondaryHeaderColor, fontSize: 13)),
                      ],
                    ),
                  ],
                ),
